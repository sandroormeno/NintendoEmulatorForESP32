...
#define HW_CONTROLLER_GPIO_START 35
...
/*
order the pines para HSPI :
  HSPI_SCLK --> 14
  HSPI_MISO --> 12
  HSPI_MOSI --> 13
  HSPI_CS ----> 15

#define FILESYSTEM_BEGIN SPIClass spi = SPIClass(HSPI); spi.begin(14, 12, 13, 15); SD.begin(15, spi, 8000000, FSROOT); FS filesystem = SD;
*/
...
#define FILESYSTEM_BEGIN SPIClass spi = SPIClass(HSPI); spi.begin(14, 34, 35, 32); SD.begin(32, spi, 8000000, FSROOT); FS filesystem = SD;// enable audio
*/
//#define HW_AUDIO
...
#define HW_CONTROLLER_GPIO_UP_DOWN 34
#define HW_CONTROLLER_GPIO_LEFT_RIGHT 32
#define HW_CONTROLLER_GPIO_SELECT 0
#define HW_CONTROLLER_GPIO_START 35
#define HW_CONTROLLER_GPIO_A 12
#define HW_CONTROLLER_GPIO_B 22
#define HW_CONTROLLER_GPIO_X 27
#define HW_CONTROLLER_GPIO_Y 33
